...
Online training of kinect random forests using one image at a time
'''
...
if __name__ == "__main__":
    ...
    online_run_folder = ("results/kinect-online-single-images-tree-%d-n-%d-m-%d-splitrate-%0.2f-splitroot-%0.2f-evalperiod-%d-maxdepth-%s-%s") % (
